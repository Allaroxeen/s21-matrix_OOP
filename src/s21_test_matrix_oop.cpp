...
TEST(SumMatrix, False) {
  ...
  EXPECT_THROW(matrix_a.SumMatrix(matrix_b), std::runtime_error);
}
TEST(SubMatrix, True) {
  S21Matrix matrix_a(2, 2);
  S21Matrix matrix_b(2, 2);
...
TEST(SubMatrix, False) {
  ...
  EXPECT_THROW(matrix_a.SubMatrix(matrix_b), std::runtime_error);
}
TEST(MulNumber, True) {
  S21Matrix matrix_a(2, 2);
  S21Matrix result(2, 2);
...
TEST(MulMatrix, False) {
  ...
  EXPECT_THROW(matrix_a.MulMatrix(matrix_b), std::runtime_error);
}
...
TEST(OperatorSumMatrix, False) {
  ...
  EXPECT_THROW((matrix_a += matrix_b), std::runtime_error);
}
...
TEST(Inverse, False) {
  ...
  EXPECT_THROW(matrix_a.InverseMatrix(), std::runtime_error);
}
TEST(Inverse, True) {
  S21Matrix matrix_a(3, 3);
