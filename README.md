...
В данном проекте реализована **s21_matrix** библиотека для работы с матрицами, используя объектно-ориентированный подход на C++. Объектно-ориентированный подход позволяет реализовать библиотеку для работы с матрицами в виде отдельного класса, над объектами которого определены операции, представленные как методами, так и стандартными операторами +, -, * и т.д.
...
Ниже представлено краткое описание операций над матрицами, реализованные в библиотеке.  
...
Помимо реализации данных операций, необходимо реализованы конструкторы и деструкторы:
